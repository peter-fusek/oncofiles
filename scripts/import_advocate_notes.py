...
FILE_MAP: list[tuple[str, str]] = [
    ...
    (
        ...
        "20250128 ErikaFusekova-PacientAdvokat-Other-NOUMudrPorsokOtazky.md",
    ),
    (
    ...
    (
        ...
        "20250206 ErikaFusekova-PacientAdvokat-Other-MudrPorsokNOUAnalyza.md",
    ),
    (
        "2026-02-03 Mudr porsok.md",
        "20260203 ErikaFusekova-PacientAdvokat-Other-MudrPorsokLiecebnyPlan.md",
    ),
    (
    ...
    (
        ...
        "20260220 ErikaFusekova-PacientAdvokat-Other-MudrPorsokHER2.md",
    ),
    (
