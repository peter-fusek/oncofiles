...
async def analyze_labs(
    ...
    if download_errors == len(labs):
        ...
        result.append(
            ...
            "vs mixed — relate to known metastases if documented.\n\n"
            "6. **PLT + thrombosis cross-check**: If patient has active VTE "
            "on anticoagulation and PLT elevated (>400), FLAG IMMEDIATELY.\n\n"
...
async def compare_labs(
    ...
    if download_errors == len(labs):
        ...
        result.append(
            ...
            "4. **PLT + thrombosis cross-check**: If active VTE on "
            "anticoagulation, PLT trending up or >400 → FLAG.\n\n"
