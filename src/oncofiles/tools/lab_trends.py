...
_PRECYCLE_CHECKLIST = {
    "lab_safety": {
        ...
        "items": [
            ...
            {
                "id": "plt",
                "text": "PLT >= 75,000/µL (tiež >= 50,000 pre plnú dávku Clexane)",
                "parameter": "PLT",
                "source": "NCCN Colon Cancer v1.2025 + Clexane SmPC",
                "source_url": "https://www.nccn.org/guidelines/guidelines-detail"
                "?category=1&id=1428",
            },
            {
            ...
            },
            {
                ...
                "parameter": "ALT",
                "source": "5-FU SmPC: ALT/AST ≤5× ULN if hepatic mets (C78.7)",
                "source_url": None,
            },
            {
                "id": "bilirubin",
    ...
    "vte_monitoring": {
        ...
        "items": [
            {
                "id": "plt_clexane",
                "text": "PLT dostatočné pre pokračovanie Clexane",
                "parameter": "PLT",
                "source": "Clexane SmPC: monitor PLT, risk of HIT",
                "source_url": None,
            },
            {
                "id": "dvt_symptoms",
            ...
            },
            {
                ...
                "text": "Potvrdená adherencia Clexane",
                "parameter": None,
