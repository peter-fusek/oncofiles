...
Real-world "before vs after" desk shoot — the only Oncofiles asset set that shows the literal physical problem and the literal digital answer in the same room on the same day. **These four photos are the complete visual set — no separate dashboard screenshots are needed.**
...
- **Patient context:** Peter's own preventive-care file (general-health profile in Oncofiles). The cover sheet's patient ID is hidden by a green sticker — confirm still hidden after any crop.
- **Licensing:** Internal Instarea use; cleared for marketing on Peter's personal LinkedIn channel and on `oncofiles.com` landing.
...
| 3 | `03-dashboard-1982-handwritten-ocr-2026-04-22.jpg` | IMG_9946.JPG | Wide shot: monitor showing `oncofiles.com/dashboard` v5.11.0.dev0 with a 1982 handwritten card rendered + structured page extraction in the right rail. |
...
- Landing-page demo blocks per `peter-fusek/oncofiles` GitHub issue (filed alongside this commit). Suggested placements: hero before/after split (photo 02 vs photo 03), dashboard preview block above-the-fold (photo 04), "what we read" carousel (1982 handwriting → modern PDF → ChatGPT export).
- Mirrored at:
  - `linkedinmarketing/linkedin-marketing/assets/oncofiles-pile-to-dashboard-2026-04-22/`
  - `oncoteam/landing/assets/pile-to-dashboard-2026-04-22/`
- LinkedIn carousel: `linkedinmarketing/.../crm/drafts/post-sk-pile-to-dashboard-2026-04-22.md`
...
## SK terminology fix (matched in landing audit issue)

- Never use **"labky"** anywhere in landing copy, dashboard UI, AI prompt outputs, or WhatsApp command help / responses. Correct forms: **"labáky"** (informal) or **"laboráky"** (slightly more formal).
